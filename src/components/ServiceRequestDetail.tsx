...
export default function ServiceRequestDetail({
            ...
            <div className="grid grid-cols-1 gap-y-4">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center">
                  ...
                  >
                    {selectedRequestData.status_description || "Unknown Status"}
                  </span>
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  {selectedRequestData.service_subtype && (
                    <div className="flex flex-col">
                      ...
                      <span>
                        {selectedRequestData.service_subtype.replace(/_/g, " ")}
                      </span>
                    </div>
                  )}
                  {selectedRequestData.service_details && (
                    <div className="flex flex-col">
                      ...
                      <span>
                        {selectedRequestData.service_details.replace(/_/g, " ")}
                      </span>
                    </div>
                  )}
                  <div className="flex flex-col">
              ...
              <div className="border-t pt-3 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span>{selectedRequestData.police_district || "N/A"}</span>
                  </div>
                </div>
              </div>
  ...
  return (
    <>
      ...
      {isDesktop ? (
        <div
          className={`fixed left-0 top-0 h-full bg-background/95 shadow-lg z-40 transition-all duration-300 ease-in-out ${
            isOpen
              ? "w-[400px] opacity-100"
